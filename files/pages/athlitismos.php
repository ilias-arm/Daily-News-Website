...
<body>
    ...
    <header id="website_header">
        ...
        <div id="upper_part">
            ...
            <div id="links">
                ...
                <a href="./pages/login.html"><img src="../logos/rss_logo.png" height="45" alt="rss"></a>
            </div>
        ...
        <nav id="top_menu">
            <ul>
                ...
                <li id="current"><a href="athlitismos.php">Αθλητισμός</a></li>
    ...
    <!-- Τα σχόλια ελιναι κοινά για όλες τις κατηγορίες (αθλητισμός, κοινωνία, κόσμος κλπ) -->
    <div id="categories">
